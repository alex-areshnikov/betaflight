...
task_attribute_t task_attributes[TASK_COUNT] = {
    ...
    [TASK_BATTERY_TEMPERATURE] = DEFINE_TASK("BATTERY_TEMPERATURE", NULL, NULL, batteryUpdateTemperature, TASK_PERIOD_HZ(1), TASK_PRIORITY_LOW),
...
void tasksInit(void)
{
    ...
    setTaskEnabled(TASK_BATTERY_TEMPERATURE, true);
